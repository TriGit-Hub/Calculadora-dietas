export type CategoriaAlimento = 'lecheEntera' | 'lecheSemi' | 'lecheDes' | 'vegetales' | 'frutas' | 'cereales' | 'carnesMagras' | 'carnesSemi' | 'carnesGordas' | 'grasas';
export type TipoComida = 'desayuno' | 'colacionAM' | 'almuerzo' | 'colacionPM' | 'cena';
...
//# sourceMappingURL=alimentos.types.d.ts.map